...
const SolutionPoint = ({ icon, text }: { icon: React.ReactNode, text: string }) => (
    <div className="flex items-start gap-4 py-3">
        <div className="mt-1 text-emerald-400 bg-emerald-900/30 p-2 rounded-full">
            {icon}
        </div>
        <p className="text-lg text-[#A3A3A3]">{text}</p>
    </div>
);
      ...
      <article className="min-h-screen bg-[#0F1115] overflow-x-hidden">
        ...
        <div className="relative overflow-hidden border-b border-white/10 pt-24 sm:pt-32">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
            <div className="mb-6 flex items-center justify-between">
              ...
              <span className="text-sm text-[#64748B]">10 min lectura</span>
            </div>
            <span className="inline-block bg-[#94A3B8]/20 text-[#94A3B8] px-4 py-1 rounded-full text-sm font-semibold mb-4">
              Tecnología & Network Marketing
            </span>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
              El Fin del Rechazo: Cómo la IA está Creando la Primera Generación de <span className="bg-gradient-to-r from-[#C5A059] to-[#D4AF37] bg-clip-text text-transparent">Networkers Millonarios</span> sin Perseguir a Nadie
            </h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <div className="bg-[#1A1D23]/50 border border-white/10 rounded-xl p-6 space-y-4">
          ...
          <motion.section
            ...
            className="mb-16"
          >
            <SectionTitle>El Secreto no es el Esfuerzo, es el <span className="bg-gradient-to-r from-[#C5A059] to-[#D4AF37] bg-clip-text text-transparent">Sistema</span></SectionTitle>
            <p className="text-lg text-[#A3A3A3] leading-relaxed mb-8">
            ...
            <div className="bg-[#15171C] border border-[#C5A059]/30 rounded-xl p-8 text-center">
          ...
          >
            ...
            <div className="bg-[#1A1D23]/50 border border-white/10 rounded-xl p-8">
          ...
          >
            ...
            <div className="space-y-6">
                <div className="bg-[#1A1D23]/50 border border-white/10 rounded-xl p-6 flex items-center gap-6">
                    <div className="flex-shrink-0 text-[#94A3B8]"><Users size={40} /></div>
                    <div>
                        <h3 className="text-xl font-bold text-white mb-2">1. TÚ (La Visión)</h3>
                        <p className="text-[#A3A3A3]">Tu rol ya no es vender, es conectar. Usas las herramientas para atraer y dejas que el sistema eduque. Aportas la estrategia y la conexión humana.</p>
                    </div>
                </div>
                <div className="bg-[#1A1D23]/50 border border-white/10 rounded-xl p-6 flex items-center gap-6">
                    <div className="flex-shrink-0 text-[#C5A059]"><Cpu size={40} /></div>
                    <div>
                        <h3 className="text-xl font-bold text-white mb-2">2. CreaTuActivo (La Ejecución IA)</h3>
                        <p className="text-[#A3A3A3]">Nuestra plataforma tecnológica exclusiva. NEXUS y las herramientas de automatización hacen el trabajo pesado, técnico y repetitivo por ti.</p>
                    </div>
                </div>
                <div className="bg-[#1A1D23]/50 border border-white/10 rounded-xl p-6 flex items-center gap-6">
                    <div className="flex-shrink-0 text-emerald-400"><Globe size={40} /></div>
                    <div>
                        <h3 className="text-xl font-bold text-white mb-2">3. Gano Excel (La Logística)</h3>
                        <p className="text-[#A3A3A3]">El gigante corporativo que pone el producto (con patente mundial), las oficinas, la logística de envíos y el capital. Cero riesgo para ti.</p>
                    </div>
                </div>
            </div>
          </motion.section>
          ...
          <motion.section
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="text-center bg-[#15171C] border border-[#C5A059]/30 p-8 lg:p-12 rounded-2xl"
          >
            <h2 className="text-3xl font-bold text-white mb-4">
              ¿Estás listo para dejar de ser vendedor y convertirte en <span className="bg-gradient-to-r from-[#C5A059] to-[#D4AF37] bg-clip-text text-transparent">Arquitecto de Sistemas</span>?
            </h2>
            ...
            <Link
              href="/fundadores"
              className="inline-flex items-center gap-3 px-8 py-4 bg-[#C5A059] text-[#0F1115] rounded-full font-semibold hover:bg-[#D4AF37] hover:shadow-xl transition-all"
            >
