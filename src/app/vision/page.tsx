            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-300 mb-2">600+ millones de personas en América. Solo necesitamos impactar al 0.67% para llegar a 4 millones.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="hidden lg:block relative">
            ...
            <div className="space-y-32">
              ...
              {/* Continue with other phases using same pattern... */}
              {/* (I'll continue with the remaining desktop phases following the same structure as the original but with "impactar" instead of "convencer") */}
